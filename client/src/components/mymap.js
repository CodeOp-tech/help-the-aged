                  ...
                  <div class="flex-container">
                    <div  class="flip-card">
                      <div class="flip-card-inner">
                        ...
                        <img src={Hands} className="handslogo" alt="Hands Logo" width="60px" height="60px"/>
                          <p>Hello, my name is <b>{helperWithActivity.name}{" "} {helperWithActivity.surname}</b>. {" "} {helperWithActivity.about_me} </p> 
                        </div>
